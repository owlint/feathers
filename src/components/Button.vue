...
.button--primary.button--indigo {
  @apply shadow-md bg-indigo-500 enabled:hover:bg-indigo-600 text-white dark:bg-indigo-500 hover:shadow-none focus:ring-2 focus:ring-indigo-400 ring-offset-2 ring-offset-slate-100 dark:ring-offset-slate-800;
}
