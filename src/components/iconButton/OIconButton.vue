<template>
  <button
    :aria-label="label"
    class="of-flex of-items-center of-justify-center hover:of-bg-opacity-10 focus:of-outline-none dark:hover:of-bg-opacity-10 dark:of-bg-transparent disabled:of-opacity-25 disabled:hover:of-bg-transparent disabled:of-cursor-not-allowed dark:of-text-slate-300 dark:hover:of-bg-slate-100 dark:focus:of-bg-slate-700"
    :class="[
